<template>
  <div class="space-y-6">
    <NuxtImg src="/avatar.png" alt="Ankit Ranjan Sinha"
    ...
    <p class="text-gray-900 dark:text-gray-400">
      I'm Ankit Ranjan, I work as a software, product engineer and designer from
      Pune, India. I specialize in building web applications and sites
